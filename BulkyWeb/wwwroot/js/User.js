                ...
                "render": function (data) {
                    ...
                    if (lockout > today) {
                        ...
                        return `<div class="text-center">
                                 ...
                                 <a href = "/admin/user/RoleManagment?userId=${data.id}" class="btn btn-danger text-white" style="cursor:pointer; width:150px;" ><i class="bi bi-pencil-square"></i> Permission   </a>
                                </div>`
                    }
                    else {
                        return `<div class="text-center">
...
function RoleManagment(id) {
    $.ajax({
        type: "POST",
        url: "/Admin/User/RoleManagment",
        data: JSON.stringify(id),
        contentType: "application/json",
        success: function (data) {
            toastr.success(data.message);
